			...
			<div class="panel-body" style="width: 100%;">
				<form action="registerForm.do" method="POST" id="registForm">
					...
					<div class="alert alert-warning" style="text-align: center;"
						id="status"></div>
					<div class="apihidden">
						ID<span class="label label-danger">필수</span>
						<div class="input-group">
							<input type="text" id="joinId" name="uid"
								class="form-control input-lg" placeholder="ID를 입력하세요" /> <span
						...
						패스워드<span class="label label-danger">필수</span> <input
							...
							class="form-control input-lg" placeholder="패스워드를 입력하세요" /> 패스워드
					...
					<div class="input-group text-center">
						<input type="text" id="joinEmail" name="umail"
							class="form-control input-lg" placeholder="Email을 입력하세요" /> <span
							class="input-group-btn">
	...
	<script type="text/javascript">
		...
		function idChk() {
			$.ajax({
				...
				function(result) {
					console.log(result);
					$("#isDuplicateId").css("visibility",
							result.show);
					$("#isDuplicateId").removeClass(
		...
		function emailChk() {
			$.ajax({
				...
				function(result) {
					console.log(result);
					$("#isDuplicateEmail").css("visibility",
							result.show);
					$("#isDuplicateEmail").removeClass(
							result.removeClass).addClass(
							result.addClass);
