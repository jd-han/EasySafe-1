...
<<<<<<< HEAD
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="active"><a
							href="${pageContext.request.contextPath}/index.do">Main</a></li>
						<c:choose>
							<c:when test="${empty uvo}">
								<li><a
									href="${pageContext.request.contextPath}/user/login.do"
									role="button">Login</a></li>
							</c:when>
							<c:when test="${uvo.ulevel eq 'admin'}">
								<li><a
									href="${pageContext.request.contextPath}/mod/listAccount.do"
									role="button">Admin Page</a></li>
								<li><a
									href="${pageContext.request.contextPath}/user/logout.do"
									role="button">Logout</a></li>
								<li><a href="#" role="button">User Info</a></li>
							</c:when>
							<c:otherwise>
								<li><a
									href="${pageContext.request.contextPath}/user/logout.do"
